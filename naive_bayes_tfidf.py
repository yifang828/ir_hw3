...
# method 1
nb_classify = Pipeline([('vect', CountVectorizer()), ('tfidf', TfidfTransformer()), ('clf', MultinomialNB())])
nb_classify = nb_classify.fit(train_x, vec_y_train)
prediction = nb_classify.predict(test_x)
...
data_test.to_csv('./data/nb_single_label_result.xls', index=False)
